...
const CustomerName = (props: Props) => {
  return (
    <View
      ...
      <View>
        <SvgXml xml={editNameXml} height={30} width={30} />
      </View>
    </View>
  );
};
